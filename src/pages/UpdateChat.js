...
const IdwiseChat=()=>{
    const requestOptions = {
      ...
      fetch(`${CLEINT_CHAT_API}/chats/chatsaccountwise/${_id}`, requestOptions)
                          ...
                          <Box ml={2}>
                            <Box display="flex" justifyContent="space-between" alignItems="center">
                              <Typography fontSize={23} m={2}>
                                ...
                                <RefreshIcon sx={{color:'#3498db',cursor:'pointer'}}
                                 onClick={IdwiseChat}/>
                              </Typography>
...
//       fetch(`http://127.0.0.1:9090/chats/chatsaccountwise/${chatId}`, requestOptions)

//         .then((response) => response.json())
//         .then((result) => {
//            console.log(result)
          
//            setchatsubject(result.accountChats.chatsubject); // Assuming setChatId is properly defined in your component's state
//            console.log(result.accountChats.chatsubject);
//           })
...
//                             <Divider
//                               sx={{
//                                 borderColor: activeChatIndex === index ? '#2c85de' : '', 
//                               }}
//                             />
//                           </Box>
//                         </Box>
